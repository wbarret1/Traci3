...
namespace Traci3
{
    ...
    class ReleaseCollectionTypeConverter : System.ComponentModel.TypeConverter
    {
        public override bool CanConvertTo(System.ComponentModel.ITypeDescriptorContext context, System.Type destinationType)
        {
            if ((typeof(Releases)).IsAssignableFrom(destinationType))
                return true;
        ...
        {
            if ((typeof(System.String)).IsAssignableFrom(destinationType) && (typeof(Releases).IsAssignableFrom(value.GetType())))
            {
                return "Releases";
            }
    ...
    [Serializable]
    [System.ComponentModel.TypeConverterAttribute(typeof(ReleaseCollectionTypeConverter))]
    public class Releases : System.ComponentModel.BindingList<Release>,
        System.ComponentModel.ICustomTypeDescriptor
    {
        ...
        System.ComponentModel.PropertyDescriptorCollection System.ComponentModel.ICustomTypeDescriptor.GetProperties()
        {
            ...
            for (int i = 0; i < this.Items.Count; i++)
            {
                ...
                ReleaseCollectionPropertyDescriptor pd = new ReleaseCollectionPropertyDescriptor(this, i);
                pds.Add(pd);
            }
            return pds;
        }
    ...
    class ReleaseCollectionPropertyDescriptor : System.ComponentModel.PropertyDescriptor
    {
        private Releases collection;
        private int index;

        public ReleaseCollectionPropertyDescriptor(Releases coll, int idx) :
